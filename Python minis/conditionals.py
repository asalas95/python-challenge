# 1. will print: oooo needs some work
x = 5
y = 10
if 2 * x > 10:
...
# 4. will print: Dan is in group three
name = "Dan"
...
# 5. will print: Can ride bumper cars
height = 66
age = 16
